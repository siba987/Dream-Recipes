...
# assume user inputs following
recipeType = "remedy"
effect = "to find true love"      
...
def generate_recipe(category, effect, ingred_list):
	...
	# describe effect in the title/ intro
	print(recipeType.capitalize()+" " + effect)
	
	grammar.add_modifiers(base_english)
	print(grammar.flatten("#origin#"))
	

generate_recipe(recipeType, effect, ['pig', 'oil' 'leaf'])
